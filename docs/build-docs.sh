...
COMPILE_DOCS="yarn tsc --project docs/tsconfig.docs.json --types react --moduleResolution node  --target esNext  --module CommonJS && generate-docs --input ./packages/ui-extensions/src/surfaces/admin/components/* --typesInput ./packages/ui-extensions/src --output ./docs/generated"
