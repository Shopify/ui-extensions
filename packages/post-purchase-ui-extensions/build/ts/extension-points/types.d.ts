...
declare type ExtractedInputFromRenderExtension<T> = T extends RenderExtension<infer Input, any> ? Input : never;
 ...
 */
export declare type InputForRenderExtension<ID extends keyof RenderExtensions> = ExtractedInputFromRenderExtension<RenderExtensions[ID]>;
/**
