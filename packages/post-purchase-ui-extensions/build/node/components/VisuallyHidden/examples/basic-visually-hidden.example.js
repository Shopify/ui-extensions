...
(0, _postPurchaseUiExtensions.extend)('Checkout::PostPurchase::Render', root => {
  const visuallyHidden = root.createComponent(_postPurchaseUiExtensions.VisuallyHidden, undefined, 'Visually hidden content although available to assistive technology');
