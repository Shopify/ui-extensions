...
- [`Checkout::PostPurchase::ShouldRender` and `Checkout::PostPurchase::Render`](/docs/api/checkout-extensions/extension-points/api), used to build post-purchase interstitials for cross sell applications.
...
For more information about the configuration file, refer to [Post-purchase extensions configuration](/docs/api/checkout-extensions/extension-points/configuration).
