...
import type {RemoteComponentType, PropsForRemoteComponent} from '@shopify/remote-ui-core';
...
>(
  ...
  ReactComponentTypeFromRemoteComponentType<RemoteComponentType<Type, Props, AllowedChildren>> {
