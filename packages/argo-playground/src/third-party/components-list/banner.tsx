...
import {Card, Stack, Banner} from '@shopify/argo-admin-react';
  ...
  return (
    <Card sectioned title="Banner component">
      <Banner title="Regular Banner" onDismiss={bannerDismissCallback}>
        Some super cool content for you in a banner. This is important stuff. Read this or you will
        not know the joys of knowing more about what this banner has to inform you of.
      </Banner>
