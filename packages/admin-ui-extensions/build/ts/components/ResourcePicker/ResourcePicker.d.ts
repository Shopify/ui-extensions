...
export declare type NestedItem = Omit<Item, 'nestedItem'>;
 ...
 */
export declare const ResourcePicker: import("@remote-ui/core").RemoteComponentType<"ResourcePicker", ResourcePickerProps, true>;
export {};
