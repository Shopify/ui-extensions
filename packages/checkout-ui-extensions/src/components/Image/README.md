...
| fit? | <code><a href="#fit">Fit</a> &#124; <a href="#conditionalstyle">ConditionalStyle</a><<wbr><a href="#fit">Fit</a><wbr>></code> | Indicates how the image fits in its frame. Use if the image is not displayed at its intrinsic size to maintain the aspect ratio.  |
