...
| position? | <code>Position &#124; <a href="#responsive">Responsive</a></code> | Changes how the View is positioned.  |
| translate? | <code><a href="#translate">Translate</a> &#124; <a href="#responsive">Responsive</a></code> | Specifies a two-dimensional translation of the View.  |
| blockAlignment? | <code>"start" &#124; "center" &#124; "end"</code> | Position children along the cross axis  |
...
| <code>"alert"</code> | Used for important, and usually time-sensitive, information. |<a name="Responsive"></a>
