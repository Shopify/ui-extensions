...
| position? | <code>Position<<wbr>InterfaceType<wbr>> &#124; <a href="#responsive">Responsive</a></code> | Changes how the View is positioned.  |
...
| Name | Type | Description |
| --- | --- | --- |
| block? | <code>Unit</code> | Adjust the translation on the cross axis.<br /><br />A percentage value refers to the block size of the View.  |
| inline? | <code>Unit</code> | Adjust the translation on the main axis.<br /><br />A percentage value refers to the inline size of the View.  |<a name="Responsive"></a>
