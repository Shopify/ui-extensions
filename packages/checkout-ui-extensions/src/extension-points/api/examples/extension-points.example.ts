...
extend('Checkout::Actions::RenderBefore', extension);
extend('Checkout::DeliveryAddress::RenderBefore', extension);
extend('Checkout::ShippingMethods::RenderAfter', extension);
