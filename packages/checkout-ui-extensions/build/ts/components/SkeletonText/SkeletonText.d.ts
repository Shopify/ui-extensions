...
export interface SkeletonTextProps extends Omit<TextProps, 'id' | 'role' | 'appearance'> {
    /**
 ...
 */
export declare const SkeletonText: import("@remote-ui/core").RemoteComponentType<"SkeletonText", SkeletonTextProps, true>;
