...
export interface PhoneFieldProps extends Pick<TextFieldProps, 'id' | 'icon' | 'name' | 'label' | 'accessibilityDescription' | 'value' | 'required' | 'error' | 'disabled' | 'readonly' | 'onFocus' | 'onBlur'> {
    /**
 ...
 */
export declare const PhoneField: import("@remote-ui/core").RemoteComponentType<"PhoneField", PhoneFieldProps, true>;
