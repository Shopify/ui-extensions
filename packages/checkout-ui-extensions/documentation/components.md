...
UI extensions have access to powerful UI components for [rendering](./rendering.md) an interface. This UI is rendered natively by Shopify, so you can depend on it to be performant, accessible, and work in all of Checkout’s supported browsers.
