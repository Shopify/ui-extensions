...
UI Extensions provide many powerful UI components that a [rendering extension](./rendering.md) can use to build an interface. This UI is rendered natively by Shopify, so you can depend on it to be performant, accessible, and work in all of Checkout’s supported browsers.
