...
export interface PixelEventsAddressSubmittedData {
  shippingAddress: MailingAddress;
}

/**
 * The `address_submitted` event logs an instance of a buyer submitting their
 * mailing address. This event is available on the checkout page
 */
export interface PixelEventsAddressSubmitted {
  clientId: ClientId;
  context: Context;
  data: PixelEventsAddressSubmittedData;
  id: Id;

  /**
   * The name of the customer event
   */
  name: 'address_submitted';
  timestamp: Timestamp;
}
...
/**
 * The `contact_step_started` event logs an instance where a buyer begins
 * interacting with a checkout form. This event is available on checkout.
 */
export interface PixelEventsContactStepStarted {
  clientId: ClientId;
  context: Context;
  id: Id;
   ...
   * The name of the customer event
   */
  name: 'contact_step_started';
  timestamp: Timestamp;
}

export interface PixelEventsContactStepSubmittedData {
  /**
...
/**
 * The `contact_step_submitted` event logs an instance where a buyer submits a
 * checkout form. This event is available on checkout.
 */
export interface PixelEventsContactStepSubmitted {
  clientId: ClientId;
  context: Context;
  data: PixelEventsContactStepSubmittedData;
  id: Id;

  /**
   * The name of the customer event
   */
  name: 'contact_step_submitted';
  timestamp: Timestamp;
}
...
/**
 * The `payment_step_started` event logs an instance where a buyer begins
 * interacting with the payment form. This event is available on checkout.
 */
export interface PixelEventsPaymentStepStarted {
  clientId: ClientId;
  context: Context;
  id: Id;
...
/**
 * The `shipping_step_started` event logs when shipping rates load. This event
 * is available on checkout.
 */
export interface PixelEventsShippingStepStarted {
  clientId: ClientId;
  context: Context;
  id: Id;
   ...
   * The name of the customer event
   */
  name: 'shipping_step_started';
  timestamp: Timestamp;
}

export interface PixelEventsShippingStepSubmittedData {
  shippingLine: ShippingRate;
}

/**
 * The `shipping_step_submitted` event logs an instance where the buyer chooses
 * a shipping rate. This event is available on checkout
 */
export interface PixelEventsShippingStepSubmitted {
  clientId: ClientId;
  context: Context;
  data: PixelEventsShippingStepSubmittedData;
  id: Id;

  /**
   * The name of the customer event
   */
  name: 'shipping_step_submitted';
  timestamp: Timestamp;
}
...
export interface PixelEvents {
   ...
   * mailing address. This event is available on the checkout page
   */
  address_submitted: PixelEventsAddressSubmitted;
   ...
   * interacting with a checkout form. This event is available on checkout.
   */
  contact_step_started: PixelEventsContactStepStarted;

  /**
   * The `contact_step_submitted` event logs an instance where a buyer submits a
   * checkout form. This event is available on checkout.
   */
  contact_step_submitted: PixelEventsContactStepSubmitted;
   ...
   * interacting with the payment form. This event is available on checkout.
   */
  payment_step_started: PixelEventsPaymentStepStarted;
   ...
   * is available on checkout.
   */
  shipping_step_started: PixelEventsShippingStepStarted;

  /**
   * The `shipping_step_submitted` event logs an instance where the buyer
   * chooses a shipping rate. This event is available on checkout
   */
  shipping_step_submitted: PixelEventsShippingStepSubmitted;
}
