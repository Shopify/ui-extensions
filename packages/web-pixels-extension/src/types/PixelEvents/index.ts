...
export interface PixelEventsAcceleratedCheckoutStartedData {
  acceleratedCheckout: AcceleratedCheckout;
}

/**
 * The `accelerated_checkout_started` event logs an instance where a customer
 * starts an accelerated checkout. This event is available on the online store
 * page. It is also available on the checkout page if the shop has [upgraded
 * to Checkout Extensibility](https://help.shopify.com/en/manual/checkout-
 * settings/checkout-extensibility/checkout-upgrade).
 */
export interface PixelEventsAcceleratedCheckoutStarted {
  clientId: ClientId;
  context: Context;
  data: PixelEventsAcceleratedCheckoutStartedData;
  id: Id;

  /**
   * The name of the customer event
   */
  name: 'accelerated_checkout_started';
  timestamp: Timestamp;
...
export interface PixelEvents {
   ...
   * settings/checkout-extensibility/checkout-upgrade).
   */
  accelerated_checkout_started: PixelEventsAcceleratedCheckoutStarted;
...
/**
 * A streamlined checkout process that automatically populates saved payment
 * and/or shipping information.
 */
export interface AcceleratedCheckout {
  /**
   * The name of the accelerated checkout service.
   */
  name: string;
}
