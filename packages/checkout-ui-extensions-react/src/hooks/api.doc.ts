...
const data: ReferenceEntityTemplateSchema = {
  ...
  defaultExample: getHookExample('api', __dirname),
  related: getLinksByTag('api', 'UseExtensionApiGeneratedType'),
};
