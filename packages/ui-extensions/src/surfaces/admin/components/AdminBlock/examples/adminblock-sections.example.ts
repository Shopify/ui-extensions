import {extension, AdminBlock, Heading, Text, Divider, BlockStack} from '@shopify/ui-extensions/admin';
...
export default extension(
  ...
  (root) => {
    ...
    const complianceSection = root.createComponent(BlockStack, {gap: true});
    ...
    const shippingSection = root.createComponent(BlockStack, {gap: true});
