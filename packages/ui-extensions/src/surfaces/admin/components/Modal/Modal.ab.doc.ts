...
- Content within the modal scrolls if it exceeds the available height.`,
  ...
  definitions: [
    ...
    },
    {
      title: 'Events',
      description:
        'The modal component provides event callbacks for handling user interactions. Learn more about [handling events](/docs/api/polaris/using-web-components#handling-events).',
      type: 'ModalEvents',
    },
    {
      title: 'Slots',
      description:
        'The modal component supports slots for additional content placement within the component. Learn more about [using slots](/docs/api/polaris/using-web-components#slots).',
      type: 'ModalSlots',
    },
  ],
  defaultExample: {
