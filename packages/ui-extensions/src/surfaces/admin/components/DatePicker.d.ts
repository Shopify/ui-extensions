...
declare class DatePicker extends BaseClass implements DatePickerProps {
    ...
    accessor onviewchange: CallbackEventListener<typeof tagName, HTMLElementEventMap['viewchange']> | null;
...
declare module 'preact' {
    namespace createElement.JSX {
        interface IntrinsicElements {
            [tagName]: Omit<HTMLAttributes<HTMLElement>, Extract<keyof HTMLAttributes<HTMLElement>, `on${Capitalize<string>}`>> & DatePickerJSXProps;
        }
    }
}
...
export interface DatePickerJSXProps extends Partial<DatePickerProps>, Pick<DatePickerProps$1, 'id'> {
    onViewChange?: ((event: CallbackEvent<typeof tagName, HTMLElementEventMap['viewchange']>) => void) | null;
