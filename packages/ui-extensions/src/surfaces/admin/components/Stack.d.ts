...
/* eslint-disable import/no-deprecated */
import type {StackProps$1,MaybeAllValuesShorthandProperty,ComponentChild} from './shared.d.ts';
...
export interface ReactProps extends Partial<StackProps>, Pick<StackProps$1, 'id'> {
}
