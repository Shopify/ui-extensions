...
- **Recognize when tooltips indicate a design problem:** If you're adding many tooltips to explain your interface, the design itself may be unclear. Consider improving labels, layout, or information architecture instead.
...
- The component doesn't provide built-in positioning controls. Tooltip placement is automatic and may not always appear in the ideal location for complex layouts.`,
    },
  ],
  definitions: [
    {
