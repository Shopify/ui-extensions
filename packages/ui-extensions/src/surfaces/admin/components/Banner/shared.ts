const shared = {
  ...
  Banners can have secondary actions that are displayed in a row. Use the \`secondary-actions\` slot to add secondary actions to the banner. Only two secondary actions of \`s-button\` are supported.
