import {extension, Pressable, Text, InlineStack, BlockStack} from '@shopify/ui-extensions/admin';
...
export default extension(
  ...
  (root) => {
    ...
    const badge1 = root.createComponent(Text, {fontWeight: 'bold'}, '142 units');
    ...
    const badge2 = root.createComponent(Text, {fontWeight: 'bold'}, '3 units');
