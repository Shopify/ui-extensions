...
/* eslint-disable import/no-deprecated */
import type {ChoiceListProps$1, TextFieldProps,ComponentChild} from './shared.d.ts';
...
export interface ReactProps extends Partial<ChoiceListProps>, Pick<ChoiceListProps$1, 'id'> {
