...
const data: ReferenceEntityTemplateSchema = {
  ...
  examples: {
    ...
    examples: [
      {
        description:
          'Collect fractional values like cost pricing and profit margins from merchants. This example uses `inputMode="decimal"` and uses `step` and `placeholder` to guide merchants through entering currency amounts and percentages with the correct precision.',
        codeblock: {
