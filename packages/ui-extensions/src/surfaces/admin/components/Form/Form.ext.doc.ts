  ...
  definitions: [
    {
      title: 'Events',
      description:
        'The form component provides event callbacks for handling user interactions. Learn more about [handling events](/docs/api/app-ui/using-web-components#handling-events).',
      type: 'FormEvents',
    },
  ],
  defaultExample: {
    ...
    exampleGroups: [
      {
        ...
        examples: [
          ...
          {
            description:
              'Organize a longer form into labeled groups so merchants can scan and complete it more easily. This example uses [sections](/docs/api/admin-extensions/{API_VERSION}/web-components/layout-and-structure/section) to separate contact information from shipping preferences.',
            codeblock: {
