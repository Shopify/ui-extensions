import {extension, Form, TextField, EmailField, Heading, Button, BlockStack} from '@shopify/ui-extensions/admin';
...
export default extension(
  ...
  (root, api) => {
    ...
    const providerSection = root.createComponent(BlockStack, {gap: true});
    ...
    const contactSection = root.createComponent(BlockStack, {gap: true});
