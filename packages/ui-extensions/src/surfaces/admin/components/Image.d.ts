...
/* eslint-disable import/no-deprecated */
import type {ImageProps$1,MaybeAllValuesShorthandProperty,ComponentChild} from './shared.d.ts';
...
export interface ReactProps extends Partial<ImageProps>, Pick<ImageProps$1, 'id'> {
