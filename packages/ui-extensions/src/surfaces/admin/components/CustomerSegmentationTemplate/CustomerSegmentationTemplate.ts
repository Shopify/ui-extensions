...
export type CustomerSegmentTemplateIcon = typeof customerSegmentTemplateIcons[number];
...
export type CustomerSegmentTemplateCategory = typeof customerSegmentTemplateCategories[number];
...
export interface CustomerSegmentationTemplateProps {
  ...
  query: string;
  /* DEPRECATED - Code snippet to insert in the segment editor. If missing
  `templateQuery` will be used. */
