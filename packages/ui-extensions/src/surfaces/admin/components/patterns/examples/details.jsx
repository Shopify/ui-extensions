<s-page heading="Mountain view">
            ...
            <s-table-row>
              <s-table-cell>
                <s-stack direction="inline" gap="base" alignItems="center">
                  ...
                  >
                    <s-image
                      alt="250 pieces puzzle template"
              ...
              <s-table-cell>
                <s-stack alignItems="end">
                  <s-button
                    ...
                    tone="neutral"
                    variant="tertiary"
                    accessibilityLabel="Remove 250 pieces puzzle template"
                  />
                </s-stack>
              </s-table-cell>
            </s-table-row>
            <s-table-row>
              <s-table-cell>
                <s-stack direction="inline" gap="base" alignItems="center">
                  ...
                  >
                    <s-image
                      alt="500 pieces puzzle template"
                      src="https://cdn.shopify.com/static/images/polaris/patterns/16-pieces.png"
                    />
                  </s-box>
                  500 pieces (Medium)
              ...
              <s-table-cell>
                <s-stack alignItems="end">
                  <s-button
                    ...
                    tone="neutral"
                    variant="tertiary"
                    accessibilityLabel="Remove 500 pieces puzzle template"
                  />
                </s-stack>
              </s-table-cell>
            </s-table-row>
  ...
  {/* Aside: Puzzle summary */}
  <s-box slot="aside">
    <s-section heading="Puzzle summary">
      <s-heading>Mountain view</s-heading>
      <s-unordered-list>
        <s-list-item>Mutiple difficulty levels</s-list-item>
        <s-list-item>Standard cardboard</s-list-item>
        <s-list-item>50 in stock</s-list-item>
        <s-list-item>
