...
export type SearchFieldProps = PreactFieldProps<Required<TextFieldProps>['autocomplete']> & Required<Pick<TextFieldProps, 'defaultValue' | 'details' | 'disabled' | 'error' | 'labelAccessibilityVisibility' | 'minLength' | 'maxLength' | 'label' | 'name' | 'placeholder' | 'readOnly' | 'required' | 'value'>>;
...
declare module 'preact' {
    namespace createElement.JSX {
        interface IntrinsicElements {
            [tagName]: Omit<HTMLAttributes<HTMLElement>, Extract<keyof HTMLAttributes<HTMLElement>, `on${Capitalize<string>}`>> & SearchFieldJSXProps;
        }
    }
}

declare const tagName = "s-search-field";
export interface SearchFieldJSXProps extends Partial<SearchFieldProps>, Pick<TextFieldProps, 'id'>, FieldReactProps<typeof tagName> {
}
