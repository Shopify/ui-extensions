...
/// <reference lib="DOM" />
import type {ComponentChildren,ChoiceProps$1,PreactCustomElement, RenderImpl} from './shared.d.ts';
...
declare module 'preact' {
    namespace createElement.JSX {
        interface IntrinsicElements {
            [tagName]: Omit<ChoiceJSXProps, 'details' | 'secondaryContent'> & PreactBaseElementPropsWithChildren<Choice>;
        }
    }
}
