  ...
  definitions: [
    {
      title: 'Slots',
      description:
        'The unordered list component supports slots for additional content placement within the component. Learn more about [using slots](/docs/api/app-ui/using-web-components#slots).',
    ...
    },
    {
      title: 'Slots',
      description:
        'The list item component supports slots for additional content placement within the component. Learn more about [using slots](/docs/api/app-ui/using-web-components#slots).',
      type: 'ListItemSlots',
    },
  ],
  defaultExample: {
