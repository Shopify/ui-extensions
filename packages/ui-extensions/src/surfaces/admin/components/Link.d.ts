...
/* eslint-disable import/no-deprecated */
import type {LinkProps$1,InteractionProps,ComponentChild} from './shared.d.ts';
...
export interface ReactProps extends Partial<LinkProps>, Pick<LinkProps$1, 'id' | 'lang'> {
