...
const data: ReferenceEntityTemplateSchema = {
  ...
  examples: {
    ...
    examples: [
      ...
      {
        description:
          "Show a loading message while fetching data from the [GraphQL Admin API](/docs/api/admin-graphql/), then replace it with product details. This example queries product information when the modal opens and displays the results after they've loaded.",
        codeblock: {
