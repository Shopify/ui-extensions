...
/// <reference lib="DOM" />
import type {TextFieldProps, URLFieldProps$1,ComponentChild} from './shared.d.ts';
...
declare module 'preact' {
    namespace createElement.JSX {
        interface IntrinsicElements {
            [tagName]: Omit<HTMLAttributes<HTMLElement>, Extract<keyof HTMLAttributes<HTMLElement>, `on${Capitalize<string>}`>> & URLFieldJSXProps;
        }
    }
}

declare const tagName = "s-url-field";
export interface URLFieldJSXProps extends Partial<Omit<URLFieldProps, 'accessory'>>, Pick<URLFieldProps$1, 'id'>, FieldReactProps<typeof tagName> {
}
