...
/* eslint-disable import/no-deprecated */
import type {GridProps$1,MaybeAllValuesShorthandProperty,ComponentChild} from './shared.d.ts';
...
export interface ReactProps extends Partial<GridProps>, Pick<GridProps$1, 'id'> {
}
