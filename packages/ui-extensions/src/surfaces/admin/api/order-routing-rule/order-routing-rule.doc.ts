...
const data: ReferenceEntityTemplateSchema = {
  ...
  defaultExample: {
    description:
      'Set preferred and fallback fulfillment locations for order routing. Applies two metafield changes in a single batch using `applyMetafieldsChange()`—New York Warehouse as preferred and Los Angeles Warehouse as fallback.',
    codeblock: {
  ...
  examples: {
    ...
    examples: [
      ...
      {
        description:
          'Configure multiple routing criteria including maximum distance (50km), inventory checking (true), and excluded zip codes (90210, 10001). Sets all criteria in one batch with different value types—integer, boolean, and JSON.',
        codeblock: {
