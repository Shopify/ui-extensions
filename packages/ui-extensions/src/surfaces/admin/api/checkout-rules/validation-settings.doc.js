...
const data = {
    ...
    examples: {
        ...
        examples: [
            {
                description: 'Block shipping to specific countries with custom error messages to comply with regulations or prevent fulfillment to restricted locations. This example demonstrates using [`TextField`](/docs/api/admin-extensions/{API_VERSION}/components/forms/textfield) inputs for countries and error messages, saving the configuration as JSON metafields, and displaying validation and function IDs for reference.',
                codeblock: {
    ...
    subSections: [
        ...
        },
        {
            ...
            title: 'Limitations',
            sectionContent: "- Metafields have [size limits](/docs/apps/build/metafields/metafield-limits). Individual values can't exceed 256KB, and total metafield storage per validation is limited.\n" +
