...
const data = {
    ...
    examples: {
        ...
        examples: [
            {
                description: "Query a product's bundle metafield and parse the JSON components array to display existing bundle configuration. This example demonstrates fetching bundle metadata using the [GraphQL Admin API](/docs/api/admin-graphql/), parsing the stored component data, and displaying the count of configured components.",
                codeblock: {
    ...
    subSections: [
        {
            ...
            sectionContent: '- **Design for products with multiple variants:** Products in `api.data.selected` may have multiple variants. Design your bundle configuration to either apply to all variants or allow variant-level configuration.\n' +
        ...
        },
        {
            ...
            title: 'Limitations',
            sectionContent: "- Configuration extensions only render in the admin. They don't affect storefront display or checkout behavior. You must implement storefront and checkout logic separately.\n" +
