...
const data: ReferenceEntityTemplateSchema = {
  ...
  defaultExample: {
    description:
      'Create a segment template targeting customers who spent $500+ across 5+ orders. This example uses `total_spent` and `orders_count` queries to identify high-value customers, which enables VIP loyalty programs or premium tier targeting.',
    codeblock: {
