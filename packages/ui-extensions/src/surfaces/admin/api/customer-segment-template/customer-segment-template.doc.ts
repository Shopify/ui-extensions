  ...
  definitions: [
    {
      ...
      description:
        'The `CustomerSegmentTemplateApi` object includes tools for creating segment templates and translating content. Access these properties through the API in the `admin.customers.segmentation-templates.render` target.',
