  ...
  subSections: [
    {
      ...
      sectionContent:
        ...
        '- **Handle loading states:** Use the `Spinner` component to indicate when your block is fetching data or processing operations.\n' +
