...
declare const Button_base: new (args_0: RenderImpl) => PreactCustomElement & PreactOverlayControlProps & PublicPreactCustomElementAPI;
...
declare const Clickable_base: new (renderImpl: RenderImpl) => BoxElement & PreactOverlayControlProps & PublicPreactCustomElementAPI;
...
export interface EmailFieldJSXProps extends Partial<Omit<EmailFieldProps, 'accessory'>>, Pick<EmailFieldProps$1, 'id'>, FieldReactProps<typeof tagName$x> {
}
...
declare const Link_base: new (args_0: RenderImpl) => PreactCustomElement & PreactOverlayControlProps & PublicPreactCustomElementAPI;
...
export interface MoneyFieldJSXProps extends Partial<MoneyFieldProps>, FieldReactProps<typeof tagName$p>, Pick<MoneyFieldProps$1, 'id'> {
}
...
export interface NumberFieldJSXProps extends Partial<NumberFieldProps>, Pick<NumberFieldProps$1, 'id'>, FieldReactProps<typeof tagName$o> {
}
...
export interface PasswordFieldJSXProps extends Partial<PasswordFieldProps>, Pick<PasswordFieldProps$1, 'id'>, FieldReactProps<typeof tagName$j> {
}
