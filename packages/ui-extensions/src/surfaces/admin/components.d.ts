...
export interface IconProps extends Pick<IconProps$1, 'type' | 'tone' | 'color' | 'size' | 'interestFor'> {
    /**
...
declare const Button_base: (abstract new (renderImpl: Omit<_shopify_admin_web_component_foundations.RenderImpl, "globalShadowCSS">) => PolarisCustomElement & PreactOverlayControlProps) & Pick<typeof PolarisCustomElement, "prototype" | "observedAttributes">;
...
declare class ButtonGroup extends PolarisCustomElement implements ButtonGroupProps {
...
export interface DropZoneProps extends Required<Pick<DropZoneProps$1, 'accept' | 'accessibilityLabel' | 'disabled' | 'files' | 'name' | 'error' | 'label' | 'labelAccessibilityVisibility' | 'multiple' | 'required' | 'value'>> {
}
...
declare const Link_base: (abstract new (renderImpl: Omit<_shopify_admin_web_component_foundations.RenderImpl, "globalShadowCSS">) => PolarisCustomElement & PreactOverlayControlProps) & Pick<typeof PolarisCustomElement, "prototype" | "observedAttributes">;
...
export interface ModalProps extends Pick<RequiredAlignedModalProps, 'accessibilityLabel' | 'heading' | 'padding' | 'size' | 'hideOverlay' | 'showOverlay' | 'toggleOverlay'> {
    /**
     * Adjust the size of the Modal.
     */
...
export interface PageProps extends Required<Pick<PageProps$1, 'inlineSize' | 'heading'>> {
...
declare class Paragraph extends PolarisCustomElement implements ParagraphProps {
    ...
    accessor tone: Extract<ParagraphProps['tone'], 'auto' | 'neutral' | 'info' | 'success' | 'caution' | 'warning' | 'critical'>;
...
export interface PopoverProps extends Required<Pick<PopoverProps$1, 'blockSize' | 'inlineSize' | 'maxBlockSize' | 'maxInlineSize' | 'minBlockSize' | 'minInlineSize'>> {
}
