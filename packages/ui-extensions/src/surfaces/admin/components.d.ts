...
export interface ReactProps$K extends Partial<BadgeProps>, Pick<BadgeProps$1, 'id'> {
}
...
export interface ReactProps$J extends Partial<BannerProps>, Pick<BannerProps$1, 'id'> {
...
export interface ReactProps$I extends Partial<BoxProps>, Pick<BoxProps$1, 'id'> {
}
...
export interface ReactProps$H extends Partial<ButtonProps>, Pick<ButtonProps$1, 'id'> {
...
export type CheckboxProps = PreactInputProps & Required<Pick<CheckboxProps$1, 'accessibilityLabel' | 'checked' | 'details' | 'error' | 'indeterminate' | 'label' | 'required' | 'defaultChecked' | 'defaultIndeterminate'>>;

declare const tagName$G = "s-checkbox";
export interface ReactProps$G extends Partial<CheckboxProps>, Pick<CheckboxProps$1, 'id'> {
    onChange?: ((event: CallbackEvent<typeof tagName$G>) => void) | null;
    onInput?: ((event: CallbackEvent<typeof tagName$G>) => void) | null;
}

export type PreactCheckboxProps = Required<Pick<CheckboxProps, 'accessibilityLabel' | 'checked' | 'defaultChecked' | 'details' | 'error' | 'label' | 'required' | 'name' | 'disabled' | 'value'>>;
...
export interface ReactProps$F extends Partial<ChoiceProps>, Pick<ChoiceProps$1, 'id'> {
}
...
export interface ReactProps$E extends Partial<ChoiceListProps>, Pick<ChoiceListProps$1, 'id'> {
...
export interface ReactProps$D extends Partial<ClickableProps>, Pick<ClickableProps$1, 'id'> {
...
export interface ReactProps$C extends Partial<DividerProps>, Pick<DividerProps$1, 'id'> {
}
...
export interface ReactProps$B extends Partial<Omit<EmailFieldProps, 'accessory'>>, Pick<EmailFieldProps$1, 'id'>, FieldReactProps<typeof tagName$B> {
}
...
export interface ReactProps$A extends Partial<GridProps>, Pick<GridProps$1, 'id'> {
}
...
export interface ReactProps$z extends Partial<GridItemProps>, Pick<GridItemProps$1, 'id'> {
}
...
export interface ReactProps$y extends Partial<HeadingProps>, Pick<HeadingProps$1, 'id'> {
}
...
export interface ReactProps$x extends Partial<IconProps>, Pick<IconProps$1, 'id'> {
}
...
export interface ImageProps extends Required<Pick<ImageProps$1, 'alt' | 'loading' | 'src' | 'accessibilityRole' | 'inlineSize' | 'srcSet' | 'sizes' | 'aspectRatio' | 'objectFit'>> {
...
export interface ReactProps$w extends Partial<ImageProps>, Pick<ImageProps$1, 'id'> {
...
export interface ReactProps$v extends Partial<LinkProps>, Pick<LinkProps$1, 'id' | 'lang'> {
...
export interface ReactProps$u extends Partial<ListItemProps>, Pick<ListItemProps$1, 'id'> {
}
...
export interface MoneyFieldProps extends PreactFieldProps, Pick<RequiredMoneyFieldProps, 'max' | 'min' | 'step' | 'currencyCode'> {
}

declare const tagName$t = "s-money-field";
export interface ReactProps$t extends Partial<MoneyFieldProps>, FieldReactProps<typeof tagName$t>, Pick<MoneyFieldProps$1, 'id'> {
}
...
export type NumberFieldProps = PreactFieldProps<Required<NumberFieldProps$1>['autocomplete']> & Required<Pick<NumberFieldProps$1, 'inputMode' | 'max' | 'min' | 'prefix' | 'step' | 'suffix'>>;

declare const tagName$s = "s-number-field";
export interface ReactProps$s extends Partial<NumberFieldProps>, Pick<NumberFieldProps$1, 'id'>, FieldReactProps<typeof tagName$s> {
}
...
export interface ReactProps$p extends Partial<OrderedListProps>, Pick<OrderedListProps$1, 'id'> {
}
...
export interface ParagraphProps extends Required<Pick<ParagraphProps$1, 'accessibilityVisibility' | 'fontVariantNumeric' | 'tone' | 'dir'>> {
...
export interface ReactProps$n extends Partial<ParagraphProps>, Pick<ParagraphProps$1, 'id'> {
}
...
export interface ReactProps$m extends Partial<PasswordFieldProps>, Pick<PasswordFieldProps$1, 'id'>, FieldReactProps<typeof tagName$m> {
}
...
export interface ReactProps$l extends Partial<SearchFieldProps>, Pick<TextFieldProps$1, 'id'>, FieldReactProps<typeof tagName$l> {
}
...
export interface ReactProps$k extends Partial<SectionProps>, Pick<SectionProps$1, 'id'> {
}
...
export type SelectProps = PreactInputProps & Required<Pick<SelectProps$1, 'details' | 'disabled' | 'error' | 'label' | 'name' | 'placeholder' | 'required' | 'value' | 'icon' | 'labelAccessibilityVisibility'>>;
...
export interface ReactProps$i extends Partial<SpinnerProps>, Pick<SpinnerProps$1, 'id'> {
}
...
export interface ReactProps$h extends Partial<StackProps>, Pick<StackProps$1, 'id'> {
}
...
export interface TableProps extends Required<Pick<TableProps$1, 'loading' | 'paginate' | 'hasPreviousPage' | 'hasNextPage'>> {
    variant: Extract<TableProps$1['variant'], 'list' | 'auto'>;
}

declare const tagName$g = "s-table";
export interface ReactProps$g extends Partial<TableProps>, Pick<TableProps$1, 'id' | 'onNextPage' | 'onPreviousPage'> {
...
export interface ReactProps$f extends Partial<TableBodyProps>, Pick<TableBodyProps$1, 'id'> {
}
...
export interface ReactProps$e extends Partial<TableCellProps>, Pick<TableCellProps$1, 'id'> {
}
...
export interface ReactProps$d extends Partial<TableHeaderProps>, Pick<TableHeaderProps$1, 'id'> {
}
...
export interface ReactProps$c extends Partial<TableHeaderRowProps>, Pick<TableHeaderRowProps$1, 'id'> {
}
...
export interface ReactProps$b extends Partial<TableRowProps>, Pick<TableRowProps$1, 'id'> {
}
...
export interface TextProps extends Required<Pick<TextProps$1, 'display' | 'accessibilityVisibility' | 'dir'>> {
...
export interface ReactProps$a extends Partial<TextProps>, Pick<TextProps$1, 'id'> {
}
...
export interface ReactProps$9 extends Partial<TextAreaProps>, Pick<TextAreaProps$1, 'id'>, FieldReactProps<typeof tagName$9> {
}
...
export interface ReactProps$8 extends Partial<Omit<TextFieldProps, 'accessory'>>, Pick<TextFieldProps$1, 'id'>, FieldReactProps<typeof tagName$8> {
...
export interface ReactProps$7 extends Partial<Omit<URLFieldProps, 'accessory'>>, Pick<URLFieldProps$1, 'id'>, FieldReactProps<typeof tagName$7> {
}
...
export interface ReactProps$6 extends Partial<UnorderedListProps>, Pick<UnorderedListProps$1, 'id'> {
}
...
export interface ReactProps$5 extends Partial<AdminActionProps>, Pick<AdminActionProps$1, 'id'> {
...
export interface ReactProps$4 extends Partial<AdminBlockProps>, Pick<AdminBlockProps$1, 'id'> {
}
...
export interface ReactProps$3 extends Partial<AdminPrintActionProps>, Pick<AdminPrintActionProps$1, 'id'> {
}
...
export { AdminAction, AdminBlock, AdminPrintAction, Badge, Banner, Box, Button, Checkbox, Choice, ChoiceList, Clickable, CustomerSegmentTemplate, Divider, EmailField, Form, FunctionSettings, Grid, GridItem, Heading, Icon, Image, Link, ListItem, MoneyField, NumberField, Option, OptionGroup, OrderedList, Page, Paragraph, PasswordField, SearchField, Section, Select, Spinner, Stack, Table, TableBody, TableCell, TableHeader, TableHeaderRow, TableRow, Text, TextArea, TextField, URLField, UnorderedList };
