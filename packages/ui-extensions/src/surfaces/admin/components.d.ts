...
type IconType =
  ...
  | 'x-circle'
  | 'x';
export interface BadgeProps$1 extends GlobalProps$1 {
  /**
...
interface AccessibilityRoleProps$1 {
  /**
...
type AccessibilityRole =
   ...
   */
  | 'none';
interface AccessibilityVisibilityProps$1 {
  /**
...
interface BaseBoxPropsWithRole extends BaseBoxProps, AccessibilityRoleProps$1 {}
export interface BoxProps$1 extends BaseBoxPropsWithRole {}
interface FocusEventProps$1 {
  /**
...
interface ButtonBehaviorProps$1 extends InteractionProps, FocusEventProps$1 {
  /**
...
interface LinkBehaviorProps$1 extends FocusEventProps$1 {
  /**
   * The URL to link to.
...
export interface InteractionProps$1 {
  /**
...
interface BasePressableProps$1
  extends ButtonBehaviorProps,
    LinkBehaviorProps$1 {}
export interface ButtonProps$1 extends GlobalProps, BasePressableProps$1 {
  /**
...
interface InputProps$1 extends BaseInputProps$1 {
  /**
...
interface BasicFieldProps$1 extends FieldErrorProps$1 {
  /**
...
interface BaseTextFieldProps$1 extends FieldProps$1 {
  /**
   * The field cannot be edited by the user. It is focusable will be announced by screen readers.
   */
  readOnly?: boolean;
}
interface FieldDecorationProps$1 {
  /**
...
interface BaseSelectableProps$1 {
  /**
...
interface BaseOptionProps$1 extends BaseSelectableProps$1 {
  /**
...
interface BaseCheckableProps$1 extends BaseSelectableProps$1 {
  /**
...
export interface CheckboxProps$1 extends GlobalProps, BaseCheckableProps$1 {
  /**
   * Indicate an error to the user. The field will be given a specific stylistic treatment
   * to communicate problems that have to be resolved immediately.
   */
...
type TextAutocompleteField = ExtractStrict<
  ...
  | `${AutocompleteFieldCreditCardAlias}-type`
>;
export interface DividerProps$1 extends GlobalProps$1 {
  /**
...
export interface HeadingProps$1
  extends GlobalProps,
    AccessibilityVisibilityProps$1 {
...
export interface IconProps$1 extends GlobalProps$1 {
  /**
...
export interface LinkProps$1 extends GlobalProps, LinkBehaviorProps$1 {
  /**
...
interface BaseTypographyProps$1 {
  /**
...
export interface SectionProps$1 extends GlobalProps$1 {
  /**
...
export interface SelectProps$1
  extends GlobalProps,
    FieldProps,
...
export interface OptionProps$1 extends GlobalProps, BaseOptionProps$1 {}
export interface OptionGroupProps$1 extends GlobalProps$1 {
  /**
...
export interface SpinnerProps$1 extends GlobalProps$1 {
  /**
...
export interface StackProps$1 extends BaseBoxPropsWithRole, GapProps$1 {
  /**
...
type TextType =
   ...
   */
  | 'generic';
export interface TextFieldProps$1
  extends GlobalProps,
    BaseTextFieldProps,
    MinMaxLengthProps,
    AutocompleteProps<TextAutocompleteField>,
    FieldDecorationProps$1 {}
type IconType$1 =
  | 'wifi'
  | 'work'
  | 'watch'
