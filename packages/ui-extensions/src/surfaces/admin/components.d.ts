...
export type IconType = "wifi" | "work" | "watch" | "wand" | "viewport-wide" | "wallet" | "viewport-short" | "viewport-tall" | "viewport-narrow" | "upload" | "unknown-device" | "undo" | "transfer" | "wrench" | "transfer-in" | "transaction-fee-rupee" | "transaction-fee-yen" | "transaction-fee-pound" | "transfer-internal" | "transaction-fee-euro" | "transaction" | "thumbs-up" | "transfer-out" | "transaction-fee-dollar" | "toggle-on" | "thumbs-down" | "theme-template" | "theme-store" | "text" | "text-with-image" | "theme-edit" | "text-title" | "text-underline" | "text-quote" | "tip-jar" | "text-indent" | "text-in-columns" | "text-italic" | "text-in-rows" | "text-color" | "text-grammar" | "text-font-list" | "theme" | "text-align-left" | "text-align-right" | "text-font" | "text-align-center" | "text-block" | "toggle-off" | "target" | "team" | "tax" | "text-bold" | "store-online" | "tablet" | "sun" | "store-import" | "stop-circle" | "store-managed" | "status-active" | "status" | "sports" | "store" | "star-filled" | "sound" | "sort-descending" | "sort-ascending" | "social-post" | "smiley-neutral" | "social-ad" | "slideshow" | "smiley-happy" | "smiley-sad" | "smiley-joy" | "shopcodes" | "shipping-label" | "shield-person" | "shield-check-mark" | "shield-none" | "shield-pending" | "share" | "settings" | "search-recent" | "search-resource" | "search" | "search-list" | "send" | "save" | "rotate-left" | "rotate-right" | "reward" | "sandbox" | "return" | "replay" | "remove-background" | "refresh" | "referral-code" | "reset" | "receipt-refund" | "receipt" | "receipt-rupee" | "receipt-paid" | "receipt-euro" | "receipt-dollar" | "receipt-pound" | "question-circle" | "profile" | "receipt-yen" | "product-remove" | "product-reference" | "product-list" | "product-unavailable" | "product-return" | "product-add" | "print" | "price-list" | "play" | "point-of-sale" | "plan" | "play-circle" | "pin" | "phone-out" | "phone-in" | "personalized-text" | "product-cost" | "person-segment" | "person-remove" | "person-add" | "redo" | "person-lock" | "payout-rupee" | "payout-pound" | "payout" | "replace" | "payout-yen" | "pause-circle" | "payout-euro" | "passkey" | "person-exit" | "payment-capture" | "paint-brush-round" | "pagination-start" | "paper-check" | "paint-brush-flat" | "pagination-end" | "page-remove" | "payout-dollar" | "page-attachment" | "page-reference" | "page-clock" | "page-up" | "page-add" | "package-returned" | "package" | "page-heart" | "package-on-hold" | "outdent" | "package-fulfilled" | "orders-status" | "outgoing" | "page-down" | "order-repeat" | "order-draft" | "organization" | "notification" | "note" | "note-add" | "nature" | "money" | "order-first" | "metaobject-reference" | "money-none" | "metaobject" | "metaobject-list" | "minimize" | "menu" | "megaphone" | "menu-vertical" | "media-receiver" | "menu-horizontal" | "moon" | "measurement-volume" | "measurement-weight" | "measurement-size" | "markets-yen" | "maximize" | "markets-rupee" | "markets-euro" | "location-none" | "live" | "markets" | "list-numbered" | "lock" | "list-bulleted" | "link" | "layout-sidebar-left" | "layout-sidebar-right" | "layout-section" | "layout-logo-block" | "layout-rows-2" | "layout-popup" | "layout-header" | "layout-columns-2" | "layout-columns-3" | "layout-buy-button" | "layout-buy-button-horizontal" | "layout-buy-button-vertical" | "layout-column-1" | "keyboard" | "layout-footer" | "layout-block" | "label-printer" | "keyboard-hide" | "key" | "inventory-updated" | "iq" | "language-translate" | "incoming" | "incentive" | "inventory" | "image-with-text-overlay" | "image" | "image-none" | "image-magic" | "mention" | "image-explore" | "import" | "image-alt" | "home" | "icons" | "identity-card" | "image-add" | "metafields" | "images" | "gauge" | "globe-europe" | "gift-card" | "hashtag" | "food" | "forms" | "forklift" | "folder-remove" | "globe-asia" | "folder-add" | "heart" | "folder-up" | "flip-vertical" | "flower" | "flip-horizontal" | "flag" | "folder-down" | "favicon" | "filter" | "file" | "eye-check-mark" | "eye-dropper" | "eye-first" | "eyeglasses" | "hashtag-decimal" | "exit" | "folder" | "export" | "games" | "envelope-soft-pack" | "email-newsletter" | "email-follow-up" | "exchange" | "enter" | "domain-new" | "domain" | "drag-handle" | "domain-redirect" | "duplicate" | "domain-landing-page" | "dns-settings" | "dock-floating" | "discount" | "envelope" | "dock-side" | "drag-drop" | "delete" | "data-table" | "database-add" | "database-connect" | "currency-convert" | "data-presentation" | "database" | "cursor-option" | "crop" | "credit-card" | "cursor" | "credit-card-reader" | "desktop" | "credit-card-percent" | "credit-card-reader-chip" | "credit-card-secure" | "credit-card-cancel" | "corner-round" | "corner-square" | "credit-card-reader-tap" | "corner-pill" | "contract" | "content" | "compass" | "connect" | "compose" | "discount-code" | "confetti" | "collection-featured" | "color-none" | "collection-reference" | "color" | "code-add" | "code" | "clipboard-checklist" | "circle" | "clipboard-check" | "collection-list" | "clipboard" | "chevron-up-circle" | "chevron-right" | "chevron-right-circle" | "chevron-down-circle" | "checkbox" | "chat-referral" | "credit-card-tap-chip" | "chat" | "chart-popular" | "chart-histogram-second-last" | "chart-stacked" | "chart-horizontal" | "chart-line" | "chart-histogram-last" | "chart-histogram-full" | "chart-histogram-flat" | "chart-histogram-growth" | "chart-histogram-first" | "chart-vertical" | "channels" | "chart-donut" | "chart-histogram-first-last" | "chart-funnel" | "catalog-product" | "categories" | "cash-yen" | "chart-cohort" | "cash-pound" | "cash-rupee" | "cash-dollar" | "cart-down" | "cart-sale" | "cash-euro" | "cart-abandoned" | "caret-down" | "caret-up" | "cart-discount" | "camera-flip" | "camera" | "cart" | "calculator" | "cart-up" | "calendar-time" | "chevron-left-circle" | "button" | "button-press" | "chevron-left" | "book" | "blog" | "book-open" | "bank" | "bug" | "backspace" | "barcode" | "arrows-in-horizontal" | "bill" | "arrows-out-horizontal" | "bullet" | "arrow-up" | "automation" | "arrow-left-circle" | "arrow-down" | "arrow-right" | "arrow-up-circle" | "arrow-right-circle" | "arrow-down-circle" | "alert-location" | "arrow-left" | "alert-diamond" | "app-extension" | "cursor-banner" | "airplane" | "affiliate" | "adjust" | "x" | "x-circle" | "variant" | "star" | "sort" | "select" | "plus" | "product" | "phone" | "plus-circle" | "person" | "page" | "payment" | "order-unfulfilled" | "order" | "order-fulfilled" | "mobile" | "merge" | "microphone" | "location" | "lightbulb" | "minus-circle" | "language" | "in-progress" | "incomplete" | "info" | "hide" | "external" | "email" | "enabled" | "edit" | "globe" | "collection" | "disabled" | "chevron-up" | "delivery" | "chevron-down" | "clock" | "check" | "view" | "calendar" | "blank" | "check-circle" | "arrow-up-right" | "minus" | "alert-circle" | "alert-bubble" | "attachment" | "archive" | "calendar-check" | "apps" | "alert-triangle";

import { IconProps as IconProps$1, BadgeProps as BadgeProps$1, BoxProps as BoxProps$1, ButtonProps as ButtonProps$1, CheckboxProps as CheckboxProps$1, TextFieldProps, DividerProps as DividerProps$1, HeadingProps as HeadingProps$1, ImageProps as ImageProps$1, LinkProps as LinkProps$1, OptionProps, OptionGroupProps, ParagraphProps as ParagraphProps$1, SectionProps as SectionProps$1, SelectProps, SpinnerProps as SpinnerProps$1, StackProps as StackProps$1, TextProps as TextProps$1 } from '@shopify/ui-api-design';
...
interface ReactProps$e extends Partial<ButtonProps>, Pick<ButtonProps$1, 'onClick' | 'onFocus' | 'onBlur' | 'id'> {
}

interface SharedProps$3 extends Required<Pick<InteractionProps, 'activateTarget'>> {
    activateAction: Extract<InteractionProps['activateAction'], 'show' | 'hide' | 'toggle' | 'auto'>;
}
declare class PreactOverlayControl extends PreactCustomElement implements SharedProps$3 {
...
interface CheckboxProps extends Required<Pick<CheckboxProps$1, 'accessibilityLabel' | 'checked' | 'details' | 'disabled' | 'error' | 'id' | 'indeterminate' | 'label' | 'name' | 'required' | 'value'>> {
}

declare const tagName$d = "shopify-checkbox";
interface ReactProps$d extends Partial<CheckboxProps>, Pick<CheckboxProps$1, 'id' | 'onChange'> {
}
...
interface ReactProps$c extends Partial<DividerProps>, Pick<DividerProps$1, 'id'> {
}
...
interface ReactProps$b extends Partial<HeadingProps>, Pick<HeadingProps$1, 'id'> {
}
...
interface ImageProps {
    accessibilityRole: Extract<ImageProps$1['accessibilityRole'], 'img' | 'presentation' | 'none'>;
...
interface ReactProps$9 extends Partial<ImageProps>, Pick<ImageProps$1, 'onError' | 'onLoad' | 'id'> {
}
...
interface ReactProps$8 extends Partial<LinkProps>, Pick<LinkProps$1, 'onClick' | 'id' | 'lang'> {
}
...
interface SharedProps$2 extends Required<Pick<OptionProps, 'disabled' | 'value'>> {
}
...
interface SharedProps$1 extends Required<Pick<OptionGroupProps, 'disabled' | 'label'>> {
}
...
interface ParagraphProps extends Required<Pick<ParagraphProps$1, 'lineClamp' | 'accessibilityVisibility' | 'fontVariantNumeric' | 'tone'>> {
    color: Extract<ParagraphProps$1['color'], 'base' | 'subdued'>;
}

declare const tagName$5 = "shopify-paragraph";
interface ReactProps$5 extends Partial<ParagraphProps>, Pick<ParagraphProps$1, 'id'> {
}
...
interface ReactProps$4 extends Partial<SectionProps>, Pick<SectionProps$1, 'id'> {
}
...
interface SharedProps extends Pick<SelectProps, 'disabled' | 'error' | 'label' | 'name' | 'placeholder' | 'required' | 'value'> {
}
...
interface ReactProps$2 extends Partial<SpinnerProps>, Pick<SpinnerProps$1, 'id'> {
}
...
interface TextProps extends Required<Pick<TextProps$1, 'display' | 'accessibilityVisibility'>> {
    color: Extract<TextProps$1['color'], 'base' | 'subdued'>;
    type: Extract<TextProps$1['type'], 'address' | 'redundant' | 'strong' | 'generic' | 'emphasis'>;
...
export { Badge, Box, Button, Checkbox, Divider, Heading, Icon, Image, Link, Option, OptionGroup, Paragraph, Section, Select, Spinner, Stack, Text };
