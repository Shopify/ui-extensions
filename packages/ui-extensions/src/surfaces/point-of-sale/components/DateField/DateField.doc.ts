...
- The component provides text-based date input—for calendar-style date selection, use the [\`DatePicker\`](/docs/api/pos-ui-extensions/2025-10/polaris-web-components/forms/datepicker) component which offers visual date selection interface.
`,
    },
  ],
  defaultExample: {
