...
const data: ReferenceEntityTemplateSchema = {
  name: 'Heading',
  description:
    'The `Heading` component renders hierarchical titles to communicate the structure and organization of page content. Heading levels adjust automatically based on nesting within parent [`Section`](/docs/api/pos-ui-extensions/2025-10/polaris-web-components/layout-and-structure/section) components, ensuring a meaningful page outline.' +
    '\n\nUse headings to create clear information hierarchy and help users navigate complex interfaces efficiently.' +
    '\n\n`Heading` components provide consistent typographic scaling that maintains visual hierarchy while ensuring headings remain readable at all levels, even when deeply nested within multiple [`Section`](/docs/api/pos-ui-extensions/2025-10/polaris-web-components/layout-and-structure/section) components.',
...
`,
    },
    {
      ...
      title: 'Limitations',
      sectionContent: `
- Heading levels are automatically determined by nesting within [\`Section\`](/docs/api/pos-ui-extensions/2025-10/polaris-web-components/layout-and-structure/section) components—manual heading level control is not available to ensure consistent document structure.
