...
const data: ReferenceEntityTemplateSchema = {
  ...
  description:
    ...
    '\n\nFor visual calendar context, use [`DatePicker`](/docs/api/pos-ui-extensions/2025-10/polaris-web-components/forms/datepicker). For exact date entry, use [`DateField`](/docs/api/pos-ui-extensions/2025-10/polaris-web-components/forms/datefield).',
