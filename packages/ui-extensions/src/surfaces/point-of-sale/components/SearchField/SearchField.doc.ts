...
const data: ReferenceEntityTemplateSchema = {
  ...
  definitions: [
    ...
    },
    {
      title: 'Events',
      description:
        'The `SearchField` component provides event callbacks for handling user interactions. Learn more about [handling events](/docs/api/app-home/using-polaris-components#handling-events).',
