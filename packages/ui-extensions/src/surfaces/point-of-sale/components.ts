...
export type {FormattedTextFieldProps} from './components/FormattedTextField/FormattedTextField';
...
export type {PinPadProps} from './components/PinPad/PinPad';
...
export type {ScreenProps} from './components/Screen/Screen';
