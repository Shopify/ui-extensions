...
export interface Session {
  ...
  /**
   * The version string of [the POS app](https://apps.api.com/shopify-pos) currently running on this device (for example, `"8.42.0"`, `"9.1.2"`). This version number follows semantic versioning and can be used for feature detection, compatibility checks, or debugging issues specific to certain POS versions.
   */
  posVersion: string;
}
