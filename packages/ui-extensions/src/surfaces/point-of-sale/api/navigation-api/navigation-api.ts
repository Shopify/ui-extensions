...
/**
 * The `Navigation` object provides methods for programmatic navigation within modal extensions. Access through the global `navigation` object to navigate between screens, access navigation history, and implement back navigation.
 * @publicDocs
 */
