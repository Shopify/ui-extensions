...
const data = {
    ...
    examples: {
        description: '',
        examples: [
            (0, helper_docs_1.getExample)('ui-components/sheet-consent', ['jsx', 'js']),
            (0, helper_docs_1.getExample)('ui-components/sheet-description-preferences', ['jsx', 'js']),
            (0, helper_docs_1.getExample)('ui-components/sheet-icon-button-preferences', ['jsx', 'js']),
            (0, helper_docs_1.getExample)('ui-components/sheet-layout-content', ['jsx', 'js']),
        ],
    },
    related: [],
};
