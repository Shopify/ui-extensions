 ...
 * Ideally we would infer the type from CHECKOUT_AVAILABLE_ICONS by doing (typeof CHECKOUT_AVAILABLE_ICONS)[number]
 * but the docs tool does not support this syntax.
 */
...
declare const tagName$T = "s-abbreviation";
...
declare global {
    interface HTMLElementTagNameMap {
        [tagName$T]: AbbreviationElement;
    }
}
declare module 'preact' {
    namespace createElement.JSX {
        interface IntrinsicElements {
            [tagName$T]: AbbreviationProps & BaseElementPropsWithChildren<AbbreviationElement>;
        }
    }
}

declare const tagName$S = "s-announcement";
...
declare global {
    interface HTMLElementTagNameMap {
        [tagName$S]: AnnouncementElement;
    }
}
declare module 'preact' {
    namespace createElement.JSX {
        interface IntrinsicElements {
            [tagName$S]: AnnouncementProps & BaseElementPropsWithChildren<AnnouncementElement>;
        }
    }
}
