...
import type {PhoneFieldProps as BasePhoneFieldProps} from '@shopify/ui-api-design/dist/components/PhoneField';
 ...
 * it can be overridden later by the user either by selecting a country
