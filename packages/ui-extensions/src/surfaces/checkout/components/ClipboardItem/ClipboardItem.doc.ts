...
const data: ReferenceEntityTemplateSchema = {
  name: 'ClipboardItem',
  description:
    'Enables clipboard functionality when its `id` is referenced by the `commandFor` property of a `Button`, `Pressable`, or `Link` component. When activated, it copies the text to the clipboard and displays a `Tooltip` confirmation. \n\n `ClipboardItem` is a non-rendering component.',
  requires: '',
