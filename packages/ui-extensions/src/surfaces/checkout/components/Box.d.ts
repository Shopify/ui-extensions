...
export interface BoxProps extends Omit<BoxProps$1, 'accessibilityRole' | 'background' | 'blockSize' | 'border' | 'borderColor' | 'borderRadius' | 'borderWidth' | 'children' | 'inlineSize' | 'containerName' | 'containerType'> {
