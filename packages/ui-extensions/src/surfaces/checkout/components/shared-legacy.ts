 ...
 * Use BorderProps['borderRadius']: https://github.com/Shopify/ui-api-design/blob/main/ui-api-design/shared/box.ts
 */
...
export type LegacyCornerRadius =
  | 'base'
  | 'small'
  | 'large'
  | 'fullyRounded'
  | 'none'
  | LegacyCornerRadiusDeprecated;
export type ExtendedLegacyCornerRadius = LegacyCornerRadius | 'max';
 ...
 * `loose`: `large`
 */
export type LegacyCornerRadiusDeprecated = 'tight' | 'loose';
...
export interface LegacyBorderProps {
  /**
...
export interface LegacyCornerProps {
  /**
   * @private
   *
  ...
  borderRadius?: MaybeResponsiveConditionalStyle<
    MaybeShorthandProperty<LegacyCornerRadius>
  >;
...
export type LegacyAccessibilityRole =
...
export type LegacyNonPresentationalAccessibilityRole =
  /** Used to indicate the primary content. */
  | 'main'
  /** Used to indicate the component is a header. */
  | 'header'
...
export type LegacyViewLikeAccessibilityRole =
  | LegacyNonPresentationalAccessibilityRole
  | [
      LegacyNonPresentationalAccessibilityRole,
      LegacyNonPresentationalAccessibilityRole,
    ];
...
export type Fit =
  ...
  | 'contain'
  /**
   * Image is sized to fill the content box. If the aspect ratio does not match
   * the aspect ratio of its box, then the image will be stretched to fit.
   */
  | 'fill';
