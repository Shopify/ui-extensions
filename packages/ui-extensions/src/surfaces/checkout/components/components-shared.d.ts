...
export interface InputProps extends BaseInputProps {
	/**
	 * A callback fired when the user has finished editing the field, such as when they blur the field or press Enter.
	 *
...
export interface BaseSelectableProps {
	/**
	 * A label used for users of assistive technologies. When set, any children or `label` supplied will not be announced.
	 * This can also be used to display a control without a visual label, while still providing context to users of assistive technologies.
	 */
	accessibilityLabel?: string;
	/**
...
export interface BaseCheckableProps extends BaseSelectableProps, InteractionProps {
	...
	name?: string;
	/**
	 * A callback fired when the control's value changes.
	 *
	 * Learn more about the [change event](https://developer.mozilla.org/en-US/docs/Web/API/HTMLElement/change_event).
	 */
	onChange?: (event: Event) => void;
 ...
 */
/**
 * A named section that scopes the autocomplete data. Use to group related fields, such as separate billing and shipping addresses on the same form.
 */
