...
// import {AnyComponent} from '../admin/components/shared';
// import type {
//   AnyComponent,
//   AllowedComponents,
//   AnyComponentExcept,
...
export type ReturnTypeForExtension<Target extends keyof ExtensionTargets> =
  ExtensionTargets[Target] extends {output: infer Output} ? Output : never;
...
export type ArgumentsForExtension<Target extends keyof ExtensionTargets> =
  ExtensionTargets[Target] extends {api: infer Api} ? [Api] : never;
