...
export function getExamples(
  ...
  return {
    ...
    'ui-components/qrcode-fill-size': {
      description:
        'In most cases the default size should work well. In most cases the default size should work well. If you need a different size, use `fill` to make it grow to the size of its parent container.',
