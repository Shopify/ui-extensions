...
export interface FieldPrefetchStandardApi<
  Target extends 'admin.product-details.dynamic.prefetch',
> {
  /**
...
interface Extension<Target extends 'admin.product-details.dynamic.prefetch'> {
  /**
