  ...
  defaultExample: {
    ...
    codeblock: {
      ...
      tabs: [
        {
          title: 'React',
          code: '../../../../../../ui-extensions-react/src/surfaces/customer-account/components/ConsentPhoneField/examples/basic-consent-phone-field.example.tsx',
          language: 'tsx',
        },
        {
          title: 'JS',
    ...
    examples: [
      {
        ...
        codeblock: {
          ...
          tabs: [
            {
              title: 'React',
              code: '../../../../../../ui-extensions-react/src/surfaces/customer-account/components/ConsentPhoneField/examples/with-consent-checkbox-consent-phone-field.example.tsx',
              language: 'tsx',
            },
            {
              title: 'JS',
