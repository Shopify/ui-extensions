  ...
  defaultExample: {
    ...
    codeblock: {
      ...
      tabs: [
        {
          title: 'React',
          code: '../../../../../../ui-extensions-react/src/surfaces/customer-account/components/Badge/examples/basic-badge.example.tsx',
          language: 'tsx',
        },
        {
          title: 'JS',
    ...
    examples: [
      {
        ...
        codeblock: {
          ...
          tabs: [
            {
              title: 'React',
              code: '../../../../../../ui-extensions-react/src/surfaces/customer-account/components/Badge/examples/status-badge.example.tsx',
              language: 'tsx',
            },
            {
              title: 'JS',
