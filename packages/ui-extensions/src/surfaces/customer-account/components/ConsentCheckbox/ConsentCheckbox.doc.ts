  ...
  defaultExample: {
    ...
    codeblock: {
      ...
      tabs: [
        {
          title: 'React',
          code: '../../../../../../ui-extensions-react/src/surfaces/customer-account/components/ConsentCheckbox/examples/basic-consent-checkbox.example.tsx',
          language: 'tsx',
        },
        {
          title: 'JS',
    ...
    examples: [
      {
        ...
        codeblock: {
          ...
          tabs: [
            {
              title: 'React',
              code: '../../../../../../ui-extensions-react/src/surfaces/customer-account/components/ConsentCheckbox/examples/with-consent-phone-field-consent-checkbox.example.tsx',
              language: 'tsx',
            },
            {
              title: 'JS',
