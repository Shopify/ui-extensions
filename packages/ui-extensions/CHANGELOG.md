...
- [#4647](https://github.com/Shopify/ui-extensions/pull/4647) [`badcef7`](https://github.com/Shopify/ui-extensions/commit/badcef7f69ca6682d6f96e270da565ba6d24a6f7) Thanks [@henryStelle](https://github.com/henryStelle)! - Fix the preact entry points in package.json:
...
- [#4627](https://github.com/Shopify/ui-extensions/pull/4627) [`1707979`](https://github.com/Shopify/ui-extensions/commit/170797943f64d0b72d12b860fa69ff0c107ed96b) Thanks [@henryStelle](https://github.com/henryStelle)! - Allow POS `s-button` components to explicitly use the default `auto` variant.

- [#4725](https://github.com/Shopify/ui-extensions/pull/4725) [`779d50c`](https://github.com/Shopify/ui-extensions/commit/779d50cb8685ddd3813f28e0b05f68ecfad3f4ce) Thanks [@johnnie-chen](https://github.com/johnnie-chen)! - Remove committed merge-conflict artifacts from the EmailField, PasswordField, PhoneField, Select, TextArea, and TextField event declarations and documentation for Checkout and Customer Account UI extensions.

## 2025.10.16

### Patch Changes

- [#4574](https://github.com/Shopify/ui-extensions/pull/4574) [`daf214b`](https://github.com/Shopify/ui-extensions/commit/daf214b60f543b9270f0ca4fca38917c119be2e6) Thanks [@justinhenricks](https://github.com/justinhenricks)! - Fix the `s-checkbox` JSX type so the documented `label` slot can be provided as slotted children. `Checkbox` now uses `BaseElementPropsWithChildren` (matching `Chip` and other slot-bearing components) instead of the childless `BaseElementProps`, which previously left `CheckboxElementSlots` unusable via JSX.

- [#4563](https://github.com/Shopify/ui-extensions/pull/4563) [`b9fc0a9`](https://github.com/Shopify/ui-extensions/commit/b9fc0a93419134574172bca7536a99b8f19f59a7) Thanks [@vctrchu](https://github.com/vctrchu)! - Remove the deprecated POS observe event extension targets and their exclusive payload types from the 2025-10 API line.
...
- [#4480](https://github.com/Shopify/ui-extensions/pull/4480) [`c52ffe2`](https://github.com/Shopify/ui-extensions/commit/c52ffe2e6b32d70edde9a3354d47493c1522bcd2) Thanks [@justinhenricks](https://github.com/justinhenricks)! - Add `textAlign` prop to the checkout `Paragraph` component, supporting `'start'`, `'end'`, `'center'`, and `'auto'` values.
