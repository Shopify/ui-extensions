...
- [#4528](https://github.com/Shopify/ui-extensions/pull/4528) [`0c173df`](https://github.com/Shopify/ui-extensions/commit/0c173df78340b256972f20b751c529f82b74989e) Thanks [@cpeddecord](https://github.com/cpeddecord)! - Release the `Chat` component (`s-chat`) to checkout UI extensions.

### Patch Changes

- [#4629](https://github.com/Shopify/ui-extensions/pull/4629) [`d2cea52`](https://github.com/Shopify/ui-extensions/commit/d2cea529fa55a4ed264d507dcbaf60f25196b571) Thanks [@henryStelle](https://github.com/henryStelle)! - Allow POS `s-button` components to explicitly use the default `auto` variant.

- [#4648](https://github.com/Shopify/ui-extensions/pull/4648) [`60b407e`](https://github.com/Shopify/ui-extensions/commit/60b407e538b5c6becd129aa88fa0302ffa02d67d) Thanks [@henryStelle](https://github.com/henryStelle)! - Fix the preact entry points in package.json:
...
- [#4726](https://github.com/Shopify/ui-extensions/pull/4726) [`b73a082`](https://github.com/Shopify/ui-extensions/commit/b73a0821ce67498dce96655189b8709cab2632d8) Thanks [@johnnie-chen](https://github.com/johnnie-chen)! - Remove committed merge-conflict artifacts from the EmailField, PasswordField, PhoneField, Select, TextArea, and TextField event declarations and documentation for Checkout and Customer Account UI extensions.

## 2026.1.5

### Patch Changes

- [#4575](https://github.com/Shopify/ui-extensions/pull/4575) [`353d173`](https://github.com/Shopify/ui-extensions/commit/353d173c5497c60e9d67e3f053ff2322f46f30a0) Thanks [@justinhenricks](https://github.com/justinhenricks)! - Fix the `s-checkbox` JSX type so the documented `label` slot can be provided as slotted children. `Checkbox` now uses `BaseElementPropsWithChildren` (matching `Chip` and other slot-bearing components) instead of the childless `BaseElementProps`, which previously left `CheckboxElementSlots` unusable via JSX.

- [#4564](https://github.com/Shopify/ui-extensions/pull/4564) [`03ef605`](https://github.com/Shopify/ui-extensions/commit/03ef6058ed393a4696150b0f9c497ae0a2c0579e) Thanks [@vctrchu](https://github.com/vctrchu)! - Remove the deprecated POS observe event extension targets and their exclusive payload types from the 2026-01 API line.
