...
|   \`Card\`                  |                                                |   Removed.                     |
|   \`CustomerAccoutAction\`  |  [CustomerAccountAction](/api/customer-account-ui-extensions/2025-10-rc/polaris-web-components/customeraccountaction)   |   Available today.       |
|   \`ImageGroup\`            |  [ImageGroup](/api/customer-account-ui-extensions/2025-10-rc/polaris-web-components/imagegroup)                         |   Available today.       |
|   \`Menu\`                  |  Moved to Checkout component library                                                    |   Coming soon.       |
|   \`Page\`                  |  [Page](/api/customer-account-ui-extensions/2025-10-rc/polaris-web-components/page)    |   Available today. |
|   \`ResourceItem\`          |  \`CollapsibleButtonGroup\` prev. \`ActionGroup\`                                      |   Coming soon. Use \`Buttons\`inline.  |
`,
    },
    {
      type: 'Generic',
      ...
      sectionCard: [
        {
          ...
          subtitle: 'More Polaris webcomponents',
