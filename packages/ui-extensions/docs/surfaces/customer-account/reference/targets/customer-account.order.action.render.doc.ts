...
const data: ReferenceEntityTemplateSchema = {
  ...
  description: `
    ...
    The root of the \`customer-account.order.action.render\` extension must be a CustomerAccountAction.
  `,
  ...
  defaultExample: {
    ...
    codeblock: {
      ...
      tabs: [
        {
          code: '../examples/targets/customer-account.order.action.render/default.example.jsx',
          language: 'jsx',
        },
      ],
    },
