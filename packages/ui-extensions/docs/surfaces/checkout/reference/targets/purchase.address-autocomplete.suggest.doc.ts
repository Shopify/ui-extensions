...
const data: ReferenceEntityTemplateSchema = {
  ...
  > - The [app extension configuration](/docs/apps/app-extensions/configuration) \`shopify.extension.toml\` file is shared between this extension target and \`purchase.address-autocomplete.format-suggestion\`. This includes extension settings specified in the configuration file.
  `,
  subCategory: 'Address',
