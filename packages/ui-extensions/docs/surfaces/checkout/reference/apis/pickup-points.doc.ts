...
This API object is provided to extensions registered for the \`Checkout::PickupPoints::RenderBefore\` or \`Checkout::PickupPoints::RenderAfter\` extension targets.
