...
This API object is provided to extensions registered for the \`Checkout::PickupLocations::RenderBefore\` or \`Checkout::PickupLocations::RenderAfter\` extension targets.
