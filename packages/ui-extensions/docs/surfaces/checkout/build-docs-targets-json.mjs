...
function parseTargetsFile() {
  // 2023-04 uses extension-points.ts instead of targets.ts
  const targetsFilePath = path.join(
    __dirname,
    '../../../src/surfaces/checkout/extension-points.ts',
  );
  ...
  // 2023-04 uses ExtensionPoints instead of ExtensionTargets
...
function parseComponents(componentString, componentTypesMap) {
  ...
  // Handle AllComponents (used in 2023-04)
  if (componentString === 'AllComponents') {
    return allComponents;
  }
