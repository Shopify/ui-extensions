...
const generateExtensionsDocs = async () => {
  ...
  const scripts = [
    ...
    `yarn generate-docs --input ./${docsRelativePath}/reference ./${docsRelativePath} ./${docsRelativePath}/../../../src/surfaces/point-of-sale/components --typesInput ./${srcRelativePath} --output ./${outputDir}`,
