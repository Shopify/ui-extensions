...
- Deprecated the [CameraScanner component](/docs/api/pos-ui-extensions/components/CameraScanner). Please use the [CameraScannerNext component](/docs/api/pos-ui-extensions/components/CameraScannerNext) instead.
      `,
    },
    {
      type: 'Generic',
