...
> Note:
> \`api_version\` needs to be declared in a \`yyyy-mm\` format. If you are using \`@shopify/ui-extensions\` version \`2024.10\` for example, you must declare your \`api_version\` as 2024-10. The patch is irrelevant to \`api_version\`.
