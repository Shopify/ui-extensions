export enum ExtensionTargetType {
  ...
  PosCashTrackingObserve = 'pos.cash-tracking.event.observe',
...
export enum TargetLink {
  ...
  PosCashTrackingObserve = '[pos.cash-tracking.event.observe](/docs/api/pos-ui-extensions/targets/cash-tracking/pos-cash-tracking-event-observe)',
