export enum ExtensionTargetType {
  ...
  PosPurchasePostBlockRenderBefore = 'pos.purchase.post.block.render-before',
  ...
  PosCashTrackingSessionDetailsActionMenuItemRender = 'pos.cash-tracking-session-details.action.menu-item.render',
  PosCashTrackingSessionDetailsActionRender = 'pos.cash-tracking-session-details.action.render',
  PosCashTrackingSessionDetailsBlockRender = 'pos.cash-tracking-session-details.block.render',
  PosCashTrackingSessionDetailsBlockRenderBefore = 'pos.cash-tracking-session-details.block.render-before',
  PosCashTrackingSessionFloatBlockRenderBefore = 'pos.cash-tracking-session-float.block.render-before',
...
export enum TargetLink {
  ...
  PosPurchasePostBlockRenderBefore = '[pos.purchase.post.block.render-before](/docs/api/pos-ui-extensions/targets/post-purchase/pos-purchase-post-block-render-before)',
  ...
  PosCashTrackingSessionDetailsActionMenuItemRender = '[pos.cash-tracking-session-details.action.menu-item.render](/docs/api/pos-ui-extensions/targets/cash-tracking/pos-cash-tracking-session-details-action-menu-item-render)',
  PosCashTrackingSessionDetailsActionRender = '[pos.cash-tracking-session-details.action.render](/docs/api/pos-ui-extensions/targets/cash-tracking/pos-cash-tracking-session-details-action-render)',
  PosCashTrackingSessionDetailsBlockRender = '[pos.cash-tracking-session-details.block.render](/docs/api/pos-ui-extensions/targets/cash-tracking/pos-cash-tracking-session-details-block-render)',
  PosCashTrackingSessionDetailsBlockRenderBefore = '[pos.cash-tracking-session-details.block.render-before](/docs/api/pos-ui-extensions/targets/cash-tracking/pos-cash-tracking-session-details-block-render-before)',
  PosCashTrackingSessionFloatBlockRenderBefore = '[pos.cash-tracking-session-float.block.render-before](/docs/api/pos-ui-extensions/targets/cash-tracking/pos-cash-tracking-session-float-block-render-before)',
