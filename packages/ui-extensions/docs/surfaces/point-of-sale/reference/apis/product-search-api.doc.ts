  ...
  definitions: [
    {
      title: 'Properties',
      description:
        'The `ProductSearchApi` object provides methods for searching and retrieving product information. Access these properties through `shopify.productSearch` to search products and fetch detailed product data.',
