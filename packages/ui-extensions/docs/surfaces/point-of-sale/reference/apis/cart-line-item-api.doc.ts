  ...
  definitions: [
    {
      title: 'Methods',
      description:
        'The `CartLineItemApi` object provides access to the current line item. Access these methods through `api.cartLineItem` to interact with the current line item context.',
