  ...
  definitions: [
    {
      title: 'Properties',
      description:
        'The `PrintApi` object provides methods for triggering document printing. Access these properties through `api.print` to initiate print operations with various document types.',
